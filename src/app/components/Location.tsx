...
export function Location() {
  return (
    <section id="ubicacion" className="py-20 bg-gradient-to-b from-white via-purple-50/20 to-purple-100/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-purple-50/30 to-white p-8 rounded-2xl shadow-lg border border-purple-200/40">
