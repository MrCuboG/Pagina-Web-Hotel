...
import img4 from "../../imports/570419945_1399777318818539_5479976156894911733_n.jpg";
const heroImages = [
  {
    url: img1,
...
export function HeroCarousel() {
  ...
  const handleQuickReservation = (e: React.FormEvent) => {
    e.preventDefault();
    if (isAuthenticated) {
      // Pasamos los datos a la vista de reservaciones
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto mt-16">
        ...
        <div className="bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-2xl border border-white/20 max-w-4xl mx-auto transform translate-y-1/2">
          <form onSubmit={handleQuickReservation} className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 bg-muted/50 rounded-xl p-3 border border-border">
              ...
              <div className="flex items-center gap-2 text-foreground">
                ...
                <input 
                  ...
                  className="bg-transparent w-full focus:outline-none font-medium cursor-pointer"
                />
              </div>
            </div>
            ...
            <button 
              type="submit"
              className="btn-primary px-8 py-4 rounded-xl text-white font-medium flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all md:w-auto h-full"
            >
              <Search size={20} />
